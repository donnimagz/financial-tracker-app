#!/usr/bin/env python3
"""
scripts/add_loan_debts.py
Records active loan balances:
- Zenka: 203,360 UGX
- MoKash: 327,000 UGX
    ...
    debts_to_add = [
        {
            "date": "2026-09-21",
            "time": "15:58:00",
            "description": "Zenka (Loan Balance Owed)",
            "merchant": "Zenka",
            "type": "Expense",
            "amount": 203360.0,
            "currency": "UGX",
            ...
            "source": "user_input",
            "confidence": "high",
            "notes": "Active loan balance owed to Zenka",
            "flag": "debt-owed",
            "tx_id": "OWED-ZENKA-20260921",
            "is_review_resolved": 1
        },
        {
            "date": "2026-09-21",
            "time": "15:58:00",
            "description": "MoKash (Loan Balance Owed)",
            "merchant": "MoKash",
            "type": "Expense",
            "amount": 327000.0,
            "currency": "UGX",
            ...
            "source": "user_input",
            "confidence": "high",
            "notes": "Active loan balance owed to MoKash",
            "flag": "debt-owed",
            "tx_id": "OWED-MOKASH-20260921",
            "is_review_resolved": 1
        }
    ]
